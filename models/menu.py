...
response.logo = A(B('Medboard'),XML('&trade;&nbsp;'),
...
response.meta.description = 'Medboard - connecting Connecting healthcare professionals who want to teach and students who want to learn.'
response.meta.keywords = 'medboard, medical, teaching, hospitals, placement, student, medical student, learning'
